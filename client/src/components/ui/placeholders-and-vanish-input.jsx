  ...
  return (
    ...
    >
      ...
      <input
        ...
        disabled={disabled}
        className={cn(
          "w-full relative text-sm sm:text-base z-50 border-none text-textPrimary bg-transparent h-full rounded-full focus:outline-none focus:ring-0 pl-4 sm:pl-6 pr-20 disabled:cursor-not-allowed",
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              exit={{ y: -15, opacity: 0 }}
              transition={{ duration: 0.3, ease: "linear" }}
              className="text-sm sm:text-base font-normal text-textSecondary pl-4 sm:pl-6 text-left w-[calc(100%-2rem)] truncate"
            >
